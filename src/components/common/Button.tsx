...
export const Button: React.FC<ButtonProps> = ({
  ...
  switch (variant) {
    case 'primary':
      ...
      break;
    case 'secondary':
      variantStyles = 'bg-secondary-500 text-white hover:bg-secondary-600 focus:ring-secondary-400';
      break;
    case 'danger':
      variantStyles = 'bg-red-600 text-white hover:bg-red-700 focus:ring-red-500';
      break;
    case 'ghost':
      variantStyles = 'bg-transparent text-primary-600 hover:bg-primary-100 focus:ring-primary-500';
      break;
  }
